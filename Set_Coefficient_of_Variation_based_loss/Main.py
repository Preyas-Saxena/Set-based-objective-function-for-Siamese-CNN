...
Model.coeffnet(model=vgg, dataloader=train_loader, valid_loader= val_loader, optimizer=optimizer, scheduler=scheduler, epochs=5, transforms=transform_list, device=device, validating=True)
